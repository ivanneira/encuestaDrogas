    ...
    <div class="row">
        ...
        <form id="frm_data" name="frm_data" action="" class="form-horizontal" onsubmit="return false;">
            ...
            <div class="tarjeta">
                ...
                <h4>Numero de cuestionario:</h4>

                <input required="true" type="number" class="form-control center-block" id="numeroCuestionario" tabindex="1" placeholder="Cuestionario Nº">
            ...
            <div class="tarjeta">
                ...
                <input required type="number" class="form-control center-block" id="edad" tabindex="2">
            ...
            <div class="tarjeta row">
                ...
                <div class="col-md-6">
                    ...
                    <select tabindex="3" id="ddDepartamento" name="departamento" class="selectpicker" data-live-search="true" title="Seleccione un departamento...">
                ...
                <div class="col-md-6">
                    ...
                    <select tabindex="4" id="ddLocalidad" name="localidad" class="selectpicker" data-live-search="true" title="Seleccione un localidad...">
            ...
            <div class="tarjeta row">
                ...
                <div class="form-check">
                    <label class="form-check-label" id="Lsexo">
                        <label>Femenino</label>
                        <input class="form-check-input" type="radio" name="sexo" id="RBsexo" value="1" >
                        <label>Masculino</label>
                        <input class="form-check-input" type="radio" name="sexo" id="RBsexo" value="2" >
            ...
            <div class="tarjeta row">
                ...
                <h4>¿Alguna vez consumió bebidas alcoholicas?</h4>

                <div class="form-check">
                    <label class="form-check-label" id="Lbebida">
                        <span class="label label-default">SI</span>
                        <input class="form-check-input" type="radio" name="bebida" id="RBbebida" value="1" >
                        <span class="label label-default">NO</span>
                        <input class="form-check-input" type="radio" name="bebida" id="RBbebida" value="0" >
            ...
            <div class="tarjeta row">
                ...
                <h4>¿Alguna vez consumió drogas?</h4>

                <div class="consumio col-md-6">

                    <div class="form-check">
                        <label class="form-check-label" id="Ldroga">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="droga" id="RBdroga" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="droga" id="RBdroga" value="0" >
                ...
                <div class="drogas noConsumio col-md-6">

                    <h5>¿Cuáles?</h5>

                    <select id="ddCualesDrogas" name="cualesDrogas" class="selectpicker" data-live-search="true" title="Seleccione...">
                        <option>Faso</option>
                        <option>Merca</option>
            ...
            <div class="tarjeta row">
                ...
                <h4>¿Alguna vez pensó que tenía que reducir su consumo de bebidas algohólicas y/o drogas?</h4>
                ...
                <div class="alcohol col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="reducirAlcohol" id="RBreducirAlcohol" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="reducirAlcohol" id="RBreducirAlcohol" value="0" >
                        </label>
                ...
                <div class="drogas col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="reducirDrogas" id="RBreducirDrogas" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="reducirDrogas" id="RBreducirDrogas" value="0" >
                        </label>
            ...
            <div class="tarjeta row">
                ...
                <h4>¿Le han molestado las observaciones de su familia acerca de sus hábitos de consumo de bebidas o drogas?</h4>
                ...
                <div class="alcohol col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="observacionesAlcohol" id="RBobservacionesAlcohol" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="observacionesAlcohol" id="RBobservacionesAlcohol" value="0" >
                        </label>
                ...
                <div class="drogas col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="observacionesDrogas" id="RBobservacionesDrogas" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="observacionesDrogas" id="RBobservacionesDrogas" value="0" >
                        </label>
            ...
            <div class="tarjeta row">
                ...
                <h4>¿Alguna vez se sintió culpable por su manera de consumir alcohol o drogas?</h4>
                ...
                <div class="alcohol col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="culpableAlcohol" id="RBculpableAlcohol" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="culpableAlcohol" id="RBculpableAlcohol" value="0" >
                        </label>
                ...
                <div class="drogas col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="culpableDrogas" id="RBculpableDrogas" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="culpableDrogas" id="RBculpableDrogas" value="0" >
                        </label>
            ...
            <div class="tarjeta row">
                ...
                <h4>¿Alguna vez tuvo que consumir algún tipo de bebida o droga para empezar el día?</h4>
                ...
                <div class="alcohol col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="diaAlcohol" id="RBdiaAlcohol" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="diaAlcohol" id="RBdiaAlcohol" value="0" >
                        </label>
                ...
                <div class="drogas col-md-6">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            <span class="label label-default">SI</span>
                            <input class="form-check-input" type="radio" name="diaDrogas" id="RBdiaDrogas" value="1" >
                            <span class="label label-default">NO</span>
                            <input class="form-check-input" type="radio" name="diaDrogas" id="RBdiaDrogas" value="0" >
                        </label>
